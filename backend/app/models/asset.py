...
class Asset(Base):
    ...
    # When True, the public product page shows a single "Trenger hjelp"
    # button that fires a Discord notification immediately (no email, no
    # form). Designed for festival/event units where speed matters.
    quick_support_enabled: Mapped[bool] = mapped_column(
